...
The root package is publishable as `@grinrus/aor@0.1.0-alpha.6`; internal
...
| --- | --- | --- |
| npm CLI alpha package | Implemented alpha | `npm install -g @grinrus/aor@0.1.0-alpha.6`. |
...
The current roadmap source of truth extends through W37 in
...
The current alpha distribution is tracked through `W37` and focuses on:
