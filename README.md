...
The root package is publishable as `@grinrus/aor@0.1.0-alpha.14`; internal
...
```bash
npm install -g @grinrus/aor@0.1.0-alpha.14
aor --help
```
...
npm exec --yes --package @grinrus/aor@0.1.0-alpha.14 -- aor --help

npm exec --yes --package @grinrus/aor@0.1.0-alpha.14 -- \
...
| --- | --- | --- |
| npm CLI alpha package | Implemented alpha | `npm install -g @grinrus/aor@0.1.0-alpha.14`. |
