...
The root package is publishable as `@grinrus/aor@0.1.0-alpha.11`; internal
...
| --- | --- | --- |
| npm CLI alpha package | Implemented alpha | `npm install -g @grinrus/aor@0.1.0-alpha.11`. |
