...
const CLI_OUTPUT_DEFAULTS = Object.freeze({
  ...
  intentSubmission: null,
  statusRef: null,
  intentNormalization: null,
  prepareBlocker: null,
  taskStart: null,
  ...
  workspaceSet: null,
  workspaceSetFile: null,
  workspaceSetRef: null,
  workspaceSetId: null,
  workspaceSetStatus: null,
  workspaceSetDigest: null,
  workspaceSetDryRun: null,
  workspaceSetIdempotent: null,
  integrationReport: null,
  integrationReportFile: null,
  integrationReportRef: null,
  integrationAuthorityFile: null,
...
const CLI_OUTPUT_FIELD_MAPPINGS = Object.freeze([
  ...
  ["intent_submission", "intentSubmission"],
  ["status_ref", "statusRef"],
  ["intent_normalization", "intentNormalization"],
  ["prepare_blocker", "prepareBlocker"],
  ...
  ["workspace_set_file", "workspaceSetFile"],
  ["workspace_set_ref", "workspaceSetRef"],
  ["workspace_set_id", "workspaceSetId"],
  ["workspace_set_status", "workspaceSetStatus"],
  ["workspace_set_digest", "workspaceSetDigest"],
  ["workspace_set_dry_run", "workspaceSetDryRun"],
  ["workspace_set_idempotent", "workspaceSetIdempotent"],
  ["integration_report", "integrationReport"],
  ["integration_report_file", "integrationReportFile"],
  ["integration_report_ref", "integrationReportRef"],
  ["integration_authority_file", "integrationAuthorityFile"],
  ...
  ["parent_run_file", "parentRunFile"],
  ["scheduled_children", "scheduledChildren"],
