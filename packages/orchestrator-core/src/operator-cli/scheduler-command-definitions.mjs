export const RUN_START_COMMAND_DEFINITION = Object.freeze({
    ...
    inputs: [
      ...
      "--execution-plan-ref <ref> (optional, paired with --workspace-set-ref)",
      "--execution-unit-id <id> (optional, selects one workspace-bound child unit)",
      "--workspace-set-ref <ref> (optional, required for structured parent and child runs)",
