...
const COMMAND_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    outputs: [
      ...
      "guided_actionable_blockers",
      "guided_recommended_commands",
      "next_action_report_id", "next_action_report_file", "next_action_status", "next_action_primary", "next_action_blockers",
      "next_action_evidence_refs", "next_action_mission_state", "next_action_artifact_readiness", "next_action_closure_state", "next_action_bounded_execution",
      "read_only",
      "future_control_hooks",
      "contract_families",
      "command_catalog_alignment",
  ...
  },
  {
    ...
    inputs: [
      ...
      "--source-kind <local-issue|local-prd|local-rfc|local-note|local-mail> (optional, repeatable, pairs by position with --source-ref)",
      "--source-ref <path|ref> (optional, repeatable, pairs by position with --source-kind)",
    ...
    outputs: [
      ...
      "next_action_artifact_readiness",
    ...
    requiredFlags: [],
    contractFamilies: ["artifact-packet", "intake-request-body", "next-action-report"],
  },
  {
  ...
  },
  {
    ...
    status: "implemented",
    summary: "List projects in the persistent Local Workspace without selecting or initializing one.",
    inputs: ["--help"],
    outputs: ["workspace", "contract_families", "command_catalog_alignment"],
    requiredFlags: [],
  ...
  },
  {
    ...
    category: "project-topology",
    status: "implemented",
    summary: "List, add, update, disable, or rebind a project repository.",
    inputs: ["--project-id <id>", "--action <list|add|update|disable|rebind>", "--value <json> (optional)", "--expected-revision <revision> (optional)", "--help"],
    outputs: ["topology", "validation", "revision_event", "contract_families", "command_catalog_alignment"],
    requiredFlags: ["project-id", "action"],
    contractFamilies: ["project-profile", "project-binding"],
  },
  {
    ...
    category: "project-topology",
    status: "implemented",
    summary: "List, add, update, or disable a project component.",
    inputs: ["--project-id <id>", "--action <list|add|update|disable>", "--value <json> (optional)", "--expected-revision <revision> (optional)", "--help"],
    outputs: ["topology", "validation", "revision_event", "contract_families", "command_catalog_alignment"],
    requiredFlags: ["project-id", "action"],
    contractFamilies: ["project-profile"],
  },
  {
    command: "project dependency",
    category: "project-topology",
    status: "implemented",
    summary: "List, upsert, or remove a component dependency.",
    inputs: ["--project-id <id>", "--action <list|upsert|remove>", "--value <json> (optional)", "--expected-revision <revision> (optional)", "--help"],
    outputs: ["topology", "validation", "revision_event", "contract_families", "command_catalog_alignment"],
    requiredFlags: ["project-id", "action"],
    contractFamilies: ["project-profile"],
  },
  {
    ...
    category: "project-topology",
    status: "implemented",
    summary: "Show, reanalyze, or validate the approved project topology.",
    inputs: ["--project-id <id>", "--action <show|reanalyze|validate>", "--expected-revision <revision> (optional)", "--help"],
    outputs: ["topology", "validation", "proposals", "revision_event", "contract_families", "command_catalog_alignment"],
    requiredFlags: ["project-id", "action"],
  ...
  },
  {
    ...
    inputs: [
      ...
      "--repo-lint-command <cmd> (optional, repeatable)",
      "--repo-test-command <cmd> (optional, repeatable)",
      "--output-quality-baseline <verify-summary> (optional, repeatable)",
    ...
    outputs: [
      ...
      "verification_plan",
      "verification_plan_command_groups",
      "verification_plan_discovered_command_groups",
      "verify_summary_file",
      "step_result_files",
  ...
  },
  {
    ...
    status: "implemented",
    summary: "Read the latest deterministically valid structured plan and its materialized handoff packet.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--help",
  ...
  },
  {
    ...
    contractFamilies: ["handoff-packet", "execution-plan", "task-progress-report"],
  },
  {
    command: "plan create",
    category: "intake-and-planning",
  ...
  },
  {
    ...
    category: "intake-and-planning",
    status: "implemented",
    summary: "Read the latest deterministically valid structured plan and its materialized wave/handoff artifacts.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--help",
  ...
  },
  {
    ...
    category: "operator-requests",
    status: "implemented",
    summary: "Create a durable operator-request for bounded runtime analysis, document proposal, repair, validation, planning, implementation, or review.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--stage <stage>",
    ...
    requiredFlags: ["project-ref", "stage", "intent", "request"],
    contractFamilies: ["operator-request"],
  },
  {
    command: "request run",
    category: "operator-requests",
    status: "implemented",
    summary: "Run bounded runtime work for an existing operator-request through routed step execution and refresh next action evidence.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--request-ref <ref>",
    ...
    requiredFlags: ["project-ref", "request-ref"],
    contractFamilies: ["operator-request", "step-result", "next-action-report"],
  },
  {
    command: "request status",
    category: "operator-requests",
    status: "implemented",
    summary: "Inspect sanitized status and refs for one durable operator-request without exposing raw request text.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--request-ref <ref>",
  ...
  },
  {
    ...
    inputs: [
      ...
      "--execution-root <path> (optional, canonical target checkout root for changed-path evidence)",
      "--reason <text> (optional)",
      "--repair-context-file <path|evidence://...> (optional, structured request-repair context)",
    ...
    outputs: [
      ...
      "review_decision_gate",
      "review_decision_reason",
      "review_decision_repair_context",
      ...
      "quality_repair_next_action_status",
      "quality_repair_next_action_stage",
    ...
    contractFamilies: ["review-decision", "quality-repair-request", "next-action-report", "review-report", "runtime-harness-report"],
  },
  {
    command: "repair retry",
    category: "quality-workflows",
    status: "implemented",
    summary: "Reserve one immutable, workspace-owned quality repair attempt with CAS and idempotency protection.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--run-id <id> (optional)",
      "--request-ref <evidence-ref|request-id> (optional with --request-id)",
      "--request-id <id> (optional with --request-ref)",
      "--command-id <id>",
      "--expected-revision <number>",
      "--workspace-ref <workspace-ref>",
      "--workspace-owner <project-ref> (optional)",
      "--execution-root <path> (optional, owned disposable workspace)",
      "--repair-run-id <id> (optional)",
      "--input-fingerprint <fingerprint> (optional)",
      "--finding-fingerprint <fingerprint> (optional)",
      "--failure-fingerprint <fingerprint> (optional)",
      "--diff-fingerprint <fingerprint> (optional)",
      "--verification-fingerprint <fingerprint> (optional)",
      "--validation-fingerprint <fingerprint> (optional)",
      "--route-ref <ref> (optional)",
      "--model <opaque-value> (optional)",
      "--failure-class <class> (optional)",
      "--evidence-ref <ref> (repeatable, new evidence)",
      "--reason <text> (optional)",
      "--help",
    ],
    outputs: [
      ...
      "quality_repair_request_file",
      "quality_repair_request_status",
      "quality_repair_request_revision",
      "quality_repair_attempt_id",
      "quality_repair_attempt_ref",
      "quality_repair_attempt_file",
      "quality_repair_attempt_index",
      "quality_repair_attempt_status",
      "quality_repair_attempt_budget",
      "quality_repair_next_action",
      "quality_repair_replay",
      "contract_families",
      "command_catalog_alignment",
    ],
    requiredFlags: ["project-ref", "command-id", "expected-revision", "workspace-ref"],
    contractFamilies: ["quality-repair-request", "quality-repair-attempt"],
  },
  {
    command: "repair close",
    category: "quality-workflows",
    status: "implemented",
    summary: "Close one bounded quality repair request from refreshed passing evidence.",
    inputs: [
      "--project-ref <path>",
      "--project-profile <path> (optional)",
      "--run-id <id>",
      ...
      "--execution-root <path> (optional, canonical disposable execution root)",
      "--help",
    ],
    outputs: [
      "resolved_project_ref",
    ...
    requiredFlags: ["project-ref", "run-id", "request-ref", "evidence-ref"],
    contractFamilies: ["quality-repair-request", "next-action-report", "review-report", "runtime-harness-report"],
  },
  {
