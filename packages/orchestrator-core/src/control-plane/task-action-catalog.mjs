...
const entries = [
  ...
  { action_id: "retry", category: "mutation", permission: "mutate", dispatch: "operator-request", payload: { request_text: { type: "string", required: false }, allowed_paths: { type: "string[]", required: false } }, requires_confirmation: false },
  { action_id: "request", category: "mutation", permission: "mutate", dispatch: "operator-request", payload: { request_text: { type: "string", required: true }, intent_type: { type: "string", required: false }, allowed_paths: { type: "string[]", required: false } }, requires_confirmation: false },
