...
const LIVE_E2E_ARTIFACT_REGEX = /^live-e2e-(agent-decision-request|operator-decision|step-observation|step-quality-assessment-report|observation-report|run-summary|run-health-report|quality-assessment-request|quality-assessment-report|controller-state|baseline-verify).*\.json$/;
