...
import { RUNNER_OUTPUT_CONTRACT_FAMILIES, RUNNER_OUTPUT_EXAMPLE_RULES } from "./runner-output-contract-families.mjs";
import { STEP_CLASS_VALUES } from "./step-class-values.mjs";
import { TASK_CONTRACT_FAMILIES, TASK_EXAMPLE_RULES } from "./task-contract-families.mjs";
...
export const CONTRACT_FAMILY_INDEX = Object.freeze([
  ...
  },
  {
    ...
    sourceContract: "docs/contracts/execution-plan.md",
    exampleGlob: "examples/packets/execution-plan-*.yaml",
    status: "implemented",
    requiredFields: [
      "execution_plan_id",
      "project_id",
  ...
  ...INTEGRATION_CONTRACT_FAMILIES,
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/task-progress-report.md",
    exampleGlob: "examples/reports/task-progress-report-*.yaml",
    status: "implemented",
    requiredFields: [
      "report_id",
      "project_id",
    ...
    enumChecks: [{ field: "overall_status", allowedValues: ["planned", "in-progress", "blocked", "failed", "stale", "complete"] }],
  },
  {
  ...
  },
  {
    ...
    fieldTypes: {
      ...
      permissions: "object",
      diff_authorization: "object",
      evidence_locks: "array",
      execution_allowed: "boolean",
      writeback_allowed: "boolean",
      target_write_allowed: "boolean",
      direct_edits_allowed: "boolean",
      meaningful_change_required: "boolean",
  ...
  },
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/evaluation-case-input.md",
    exampleGlob: "examples/eval/cases/**/input.yaml",
    status: "implemented",
    requiredFields: ["family", "case_id", "version", "subject_type", "content"],
    fieldTypes: {
      family: "string",
      case_id: "string",
      version: "number",
    ...
    enumChecks: [{ field: "family", allowedValues: ["evaluation-case-input"] }],
  },
  {
    family: "evaluation-case-expected",
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/evaluation-case-expected.md",
    exampleGlob: "examples/eval/cases/**/expected.yaml",
    status: "implemented",
    requiredFields: ["family", "case_id", "version", "subject_type", "assertions"],
    fieldTypes: {
      family: "string",
      case_id: "string",
      version: "number",
    ...
    enumChecks: [{ field: "family", allowedValues: ["evaluation-case-expected"] }],
  },
  {
...
export const EXAMPLE_FAMILY_RESOLUTION_RULES = Object.freeze([
  ...
  { regex: /^examples\/eval\/cases\/.+\/input\.ya?ml$/, family: "evaluation-case-input" },
  { regex: /^examples\/eval\/cases\/.+\/expected\.ya?ml$/, family: "evaluation-case-expected" },
  ...
  { regex: /^examples\/packets\/execution-plan-[^/]+\.ya?ml$/, family: "execution-plan" },
  { regex: /^examples\/reports\/task-progress-report-[^/]+\.ya?ml$/, family: "task-progress-report" },
