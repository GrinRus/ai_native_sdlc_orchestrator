...
export const CONTRACT_FAMILY_INDEX = Object.freeze([
  ...
  },
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/live-e2e-run-health-report.md",
    exampleGlob: "examples/reports/live-e2e-run-health-report*.yaml",
    status: "implemented",
    requiredFields: [
      "report_id",
      "run_id",
  ...
  },
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/live-e2e-quality-assessment-report.md",
    exampleGlob: "examples/reports/live-e2e-quality-assessment-report*.yaml",
    status: "implemented",
    requiredFields: [
      "assessment_id",
      "run_id",
  ...
  },
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/live-e2e-step-quality-assessment-request.md",
    exampleGlob: "examples/reports/live-e2e-step-quality-assessment-request*.yaml",
    status: "implemented",
    requiredFields: [
      "request_id",
      "run_id",
  ...
  },
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/live-e2e-step-quality-assessment-report.md",
    exampleGlob: "examples/reports/live-e2e-step-quality-assessment-report*.yaml",
    status: "implemented",
    requiredFields: [
      "assessment_id",
      "run_id",
...
export const EXAMPLE_FAMILY_RESOLUTION_RULES = Object.freeze([
  ...
  { regex: /^examples\/reports\/live-e2e-run-health-report[^/]*\.ya?ml$/, family: "live-e2e-run-health-report" },
  { regex: /^examples\/reports\/live-e2e-quality-assessment-report[^/]*\.ya?ml$/, family: "live-e2e-quality-assessment-report" },
  { regex: /^examples\/reports\/live-e2e-step-quality-assessment-request[^/]*\.ya?ml$/, family: "live-e2e-step-quality-assessment-request" },
  { regex: /^examples\/reports\/live-e2e-step-quality-assessment-report[^/]*\.ya?ml$/, family: "live-e2e-step-quality-assessment-report" },
