...
const taskBase = {
  ...
  attention_items: [],
  review: { verification_status: "pass", delivery_status: "pass", changed_paths: ["docs/auth-timeouts.md", "src/auth/timeout.ts"], evidence_refs: ["evidence://review/live-ui.patch"] },
  completion: { status: "complete", verification_status: "pass", delivery_status: "pass", patch_ref: "evidence://delivery/live-ui.patch", digest: "b".repeat(64), evidence_refs: ["evidence://completion/live-ui"], follow_up_eligible: true },
