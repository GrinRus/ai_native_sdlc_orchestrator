...
export function TaskWorkspace({ project, tasks = [], selectedTaskId = null, onSelectTask, onNewTask, onCreateTask, onTaskAction, onReviewDecision, loadTaskReview, actionBusy = false, actionError = null, onRefresh, onOpenProject, connectionState = "connected", resourceError = null, pending = false }) {
