...
const COMMAND_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    requiredFlags: ["project-ref"],
    contractFamilies: ["live-run-event", "step-result"],
  },
  {
    command: "run pause",
    category: "execution-lifecycle",
  ...
  },
  {
    ...
    requiredFlags: ["project-ref", "run-id"],
    contractFamilies: ["review-report"],
  },
  {
    ...
    requiredFlags: ["project-ref", "run-id"],
    contractFamilies: ["learning-loop-scorecard", "learning-loop-handoff", "incident-report"],
  },
  {
    command: "ui detach",
    category: "ui-lifecycle",
