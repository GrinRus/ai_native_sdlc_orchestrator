...
- Its optional `primary_action.operator_control` is the authoritative structured browser projection. Legacy `command` fields remain compatible diagnostics and must not be parsed into browser mutations.
