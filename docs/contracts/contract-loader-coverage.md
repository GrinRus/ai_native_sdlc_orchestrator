...
| Execution and quality | `live-e2e-run-health-report.md` | `live-e2e-run-health-report` | `examples/reports/live-e2e-run-health-report*.yaml` | implemented | Factual run-health contract for lifecycle, command, controller, evidence, owner/phase/class, and resume/interaction gaps without code/artifact/UI quality judgement. |
