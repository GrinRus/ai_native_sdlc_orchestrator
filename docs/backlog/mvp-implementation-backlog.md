...
| W44-S05 | Post-implementation docs and internal installed-user rehearsal validation | EPIC-0, EPIC-7 | ready | `README.md`, `docs/architecture/**`, `docs/contracts/**`, `docs/ops/**`, `internal maintainer rehearsal fixtures`, `internal maintainer rehearsal tooling`, tests | W44-S04 |
