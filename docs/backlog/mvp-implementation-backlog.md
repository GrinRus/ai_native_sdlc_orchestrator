...
| W44-S04 | Context, skill, and policy overlays from evidence | EPIC-4, EPIC-3 | ready | `examples/context/**`, `examples/skills/**`, `examples/policies/**`, `packages/orchestrator-core/**`, `packages/contracts/**`, `docs/architecture/**`, tests | W44-S02, W44-S03 |
