...
| W0-S02 | Contracts package and schema loader baseline | EPIC-0 | blocked | `packages/contracts`, `docs/contracts/**`, `examples/**` | W0-S01 |
| W0-S03 | Example and reference integrity checks | EPIC-0 | blocked | `packages/contracts`, `examples/**`, root validation scripts | W0-S02 |
...
| Slice ID | Title | Epic | State | Primary modules | Hard dependencies |
|---|---|---|---|---|---|
| W1-S01 | Bootstrap CLI shell and command contracts | EPIC-6 | blocked | `apps/cli`, `docs/architecture/14-cli-command-catalog.md`, `docs/contracts/**` | W0-S01, W0-S02 |
