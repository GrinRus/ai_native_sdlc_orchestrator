...
| W21-S06 | Review, delivery, release, and learning closure UX | EPIC-4 | ready | `docs/contracts/**`, `packages/orchestrator-core`, `packages/observability`, `apps/cli`, `apps/api`, `apps/web`, `docs/ops/**`, tests | W19-S05, W21-S05 |
