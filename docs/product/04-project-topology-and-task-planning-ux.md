...
The current console target in `08-task-workspace-console-design.md` places
applicable Plan, Execution, Integration, and coordinated-delivery evidence
inside the selected Task's activity, checks, evidence, and recovery surfaces.
