...
The accepted ADRs keep this alpha boundary explicit:
- `docs/architecture/adr/0021-central-aor-home-and-portable-project-config.md` makes AOR Home the mutable system of record and supersedes ADR 0001.
