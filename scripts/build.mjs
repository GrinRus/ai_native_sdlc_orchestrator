...
import { discoverWaveFiles as discoverBacklogWaveFiles } from "./slice-cycle-lib.mjs";
...
function discoverWaveFiles() {
  try {
    return discoverBacklogWaveFiles(root);
  } catch (error) {
...
const requiredFiles = [
  ...
  "scripts/bootstrap-remediation-gate.mjs",
  "scripts/bootstrap-remediation-manifest.json",
  "scripts/readiness/w71-disposition.mjs",
  "scripts/build.mjs",
