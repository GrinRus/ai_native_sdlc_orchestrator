...
const OPERATOR_REQUEST_STAGE_VALUES = [
  "readiness",
  "mission",
  "discovery",
  "research",
...
const OPERATOR_REQUEST_INTENT_VALUES = [
  "analyze",
  "explain",
  "revise-document",
  "create-document",
...
export const CONTRACT_FAMILY_INDEX = Object.freeze([
  ...
  },
  {
    ...
    exampleGlob: "examples/packets/artifact-packet*.yaml",
    status: "implemented",
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/incident-report*.yaml",
    status: "implemented",
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/step-result*.yaml",
    status: "implemented",
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/validation-report*.yaml",
    status: "implemented",
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/review-report*.yaml",
    status: "implemented",
    requiredFields: [
      "review_report_id",
      "project_id",
  ...
  },
  {
    ...
    fieldTypes: {
      ...
      hashes: "object",
      provenance: "object",
      budget_report: "object",
      compaction_report: "object",
    },
    enumChecks: [],
  },
  {
    ...
    familyGroup: "execution-and-quality",
    sourceContract: "docs/contracts/operator-request.md",
    exampleGlob: "examples/reports/operator-request*.yaml",
    status: "implemented",
    requiredFields: [
      "request_id",
      "project_id",
    ...
    enumChecks: [
      ...
      { field: "intent_type", allowedValues: OPERATOR_REQUEST_INTENT_VALUES },
      { field: "delivery_mode", allowedValues: DELIVERY_MODE_VALUES },
      { field: "status", allowedValues: OPERATOR_REQUEST_STATUS_VALUES },
    ],
  },
  {
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/live-run-event*.yaml",
    status: "implemented",
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/learning-loop-scorecard*.yaml",
    status: "implemented",
    requiredFields: [
      "scorecard_id",
      "project_id",
  ...
  },
  {
    ...
    exampleGlob: "examples/reports/learning-loop-handoff*.yaml",
    status: "implemented",
    requiredFields: [
      "handoff_id",
      "project_id",
...
export const EXAMPLE_FAMILY_RESOLUTION_RULES = Object.freeze([
  ...
  { regex: /^examples\/packets\/artifact-packet[^/]*\.ya?ml$/, family: "artifact-packet" },
  ...
  { regex: /^examples\/reports\/operator-request[^/]*\.ya?ml$/, family: "operator-request" },
