...
11. For guided profiles, inspect `frontend_interactions[]` and the linked web smoke evidence. AOR operator browser/UI evidence must be tied to the relevant step observation.
